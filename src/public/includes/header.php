  ...
  <main>
    ...
    <header class="py-3 border-bottom bg-light">
      <div class="container d-flex flex-wrap justify-content-center">
        <a href="http://localhost/src/public/index.php" class="d-flex align-items-center mb-3 mb-lg-0 me-lg-auto link-body-emphasis text-decoration-none">
          <svg class="bi me-2" width="40" height="32">
            <use xlink:href="#bootstrap" />
          </svg>
          <span class="fs-4">Drinkki Opas</span>
        </a>
        <form class="col-12 col-lg-auto mb-3 mb-lg-0" role="search">
          <input type="search" id="live_search" class="form-control" placeholder="Etsi juomaa..." aria-label="Search">
        </form>
      </div>
    </header>
